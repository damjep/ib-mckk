...
export const IbCoco = () => {
    return (<>
    <SideBar/>
    <div className="ibcoco-main">
        <div style={{flex: 'auto', justifyContent: 'center', height: 'auto', display: 'flex', maxHeight: '45vh', margin: '2em'}} className="ibcoco-img-container">
            <img src={require("./ibdp.png")} alt="IB" className="ibcoco-img"/>
        </div>
        
        <div style={{flex: 'auto', justifyContent: 'center', height: 'auto', display: 'flex', maxHeight: '45vh', margin: '2em'}}>
            <p>
